...
@section('PageCustomJS')
    <script>
        ...
        var moduleSelectionUrl = '{{ route("Clients.ModuleSelection.Index", ":id") }}';
        var extensionSelectionUrl = '{{ route("Clients.ExtensionSelection.Index", ":id") }}';
            ...
            dt = $("#datatable").DataTable({
                ...
                columnDefs: [
                    ...
                    { targets: -1,
                        ...
                        render: function (data, type, row) {
                            if(row.pbxStatus == true) {
                                return `
                                <a class="btn btn-icon btn-light-primary" href="`+ moduleSelectionUrl.replace(':id', row.id) +`" style="height: calc(2.05em);"><i class="fas fa-server fs-5" style="margin-top: 1px;"></i></a>
                                <a class="btn btn-icon btn-light-info" href="`+ extensionSelectionUrl.replace(':id', row.id) +`" style="height: calc(2.05em);"><i class="fas fa-phone fs-5" style="margin-top: 1px;"></i></a>
