...
@section('PageTitle', __('messages.client_extension_selection.index.01'))
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 mb-0">
                            ...
                            @foreach($extensions as $extension)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="#" class="form-check form-switch form-check-custom form-check-solid" style="float: right">
