...
@section('PageTitle', __('messages.extensions.index.01'))
        ...
        <div class="col-xl-12">
            <div class="alert alert-info d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    <h4 class="mb-1">@ {{ __('messages.extensions.alert.01') }}</h4>
                    <span>- {{ __('messages.extensions.alert.02') }}</span>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('Extensions.Create') }}" class="btn btn-light-success btn-icon btn-sm">
                    ...
                    <div class="row p-0">
                        ...
                        <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                            ...
                            <tr class="fw-bolder fs-7 text-uppercase gy-5">
                                ...
                                <th>{{ __('messages.extensions.index.datatables.01') }}</th>
                                <th>{{ __('messages.extensions.index.datatables.02') }}</th>
                                <th>{{ __('messages.extensions.index.datatables.03') }}</th>
...
@section('PageCustomJS')
    <script>
        var table, dt;
        var editUrl = '{{ route("Extensions.Edit", ":id") }}';
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "extensions/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
