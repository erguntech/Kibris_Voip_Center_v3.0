...
@section('PageTitle', __('messages.activity_logs.index.02'))
        ...
        <div class="col-xl-12">
            <div class="alert alert-info d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>- {{ __('messages.activity_logs.alert.03') }}</span>
                </div>
            </div>
            <div class="card">
