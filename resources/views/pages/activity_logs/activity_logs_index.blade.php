            ...
            dt = $("#datatable").DataTable({
                ...
                columnDefs: [
                    ...
                    { targets: -1,
                        ...
                        render: function (data, type, row) {
                            return `<a class="btn btn-icon btn-light-primary" onclick="viewDetailModal(`+row.id+`)" style="height: calc(2.05em);"><i class="fas fa-eye fs-5" style="margin-top: 1px;"></i></a>`;
                        },
                    },
