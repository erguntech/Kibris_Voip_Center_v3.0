...
@section('PageTitle', __('messages.call_center_clients.create.01'))
...
@section('Breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 ">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('Clients.Index') }}" class="text-muted text-hover-primary">{{ __('messages.call_center_clients.index.01') }}</a>
        </li>
    </ul>
@endsection
        ...
        <div class="col-xl-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.call_center_clients.create.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('CallCenterClients.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-assigned_user_id') is-invalid error-input @enderror" name="input-assigned_user_id" id="input-assigned_user_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    ...
                                    @foreach($employees as $employee)
                                        <option value="{{ $employee->id }}" @if (old('input-assigned_user_id') == $employee->id) selected="selected" @endif>{{ $employee->linkedUser->getUserFullName() }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-first_name" id="input-first_name" class="form-control @error('input-first_name') is-invalid error-input @enderror" placeholder="{{ __('messages.call_center_clients.form.02') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-first_name') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-last_name" id="input-last_name" class="form-control @error('input-last_name') is-invalid error-input @enderror" placeholder="{{ __('messages.call_center_clients.form.03') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-last_name') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-company_name" id="input-company_name" class="form-control @error('input-company_name') is-invalid error-input @enderror" placeholder="{{ __('messages.call_center_clients.form.04') }} {{ __('messages.forms.01') }}" maxlength="150" value="{{ old('input-company_name') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-contact_no" id="input-contact_no" class="form-control @error('input-contact_no') is-invalid error-input @enderror" placeholder="{{ __('messages.call_center_clients.form.05') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-contact_no') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active') == '1' ? 'selected' : '' }}>{{ __('messages.call_center_clients.form.08.01') }}</option>
                                    <option value="0" {{ old('input-is_active') == '0' ? 'selected' : '' }}>{{ __('messages.call_center_clients.form.08.02') }}</option>
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <textarea name="input-description" id="input-description" class="form-control @error('input-description') is-invalid error-input @enderror" rows="8" placeholder="{{ __('messages.call_center_clients.form.06') }} {{ __('messages.forms.01') }}" maxlength="750">{{ old('input-description') }}</textarea>
