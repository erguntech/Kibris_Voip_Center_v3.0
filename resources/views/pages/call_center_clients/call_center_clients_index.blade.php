...
@section('PageTitle', __('messages.call_center_clients.index.01'))
                ...
                <div class="card-body">
                    <div class="row p-0">
                        ...
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-success d-block">{{ __('messages.call_center_clients.index.03') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $dataActiveCount + $dataPassiveCount }}">{{ $dataActiveCount + $dataPassiveCount }}</span>
                            </div>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-primary d-block">{{ __('messages.call_center_clients.index.04') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $dataActiveCount }}">{{ $dataActiveCount }}</span>
                            </div>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-danger d-block">{{ __('messages.call_center_clients.index.05') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $dataPassiveCount }}">{{ $dataPassiveCount }}</span>
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            ...
                            <th>{{ __('messages.call_center_clients.index.datatables.05') }}</th>
    ...
    <script>
        ...
        var initDatatable = function () {
            dt = $("#datatable").DataTable({
                ...
                info: false,
                ajax: {
                    url : "{{ route('CallCenterClients.Index') }}",
                },
                language: {
                    @if(App::getLocale() == 'tr')
