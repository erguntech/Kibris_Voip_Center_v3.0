                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-extension_no') is-invalid error-input @enderror" name="input-extension_no" id="input-extension_no" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="0" {{ old('input-extension_no') == '0' ? 'selected' : '' }}>{{ __('messages.employees.form.01.01') }}</option>
                                    @foreach($emptyExtensions as $emptyExtension)
                                        <option value="{{ $emptyExtension['extension'] }}" @if (old('input-extension_no') == $emptyExtension['extension']) selected="selected" @endif>{{ $emptyExtension['extension'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-show_numbers') is-invalid error-input @enderror" name="input-show_numbers" id="input-show_numbers" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-show_numbers') == '1' ? 'selected' : '' }}>{{ __('messages.employees.form.03.01') }}</option>
                                    <option value="0" {{ old('input-show_numbers') == '0' ? 'selected' : '' }}>{{ __('messages.employees.form.03.02') }}</option>
                                </select>
