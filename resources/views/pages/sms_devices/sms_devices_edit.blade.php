...
@section('PageTitle', __('messages.sms_devices.edit.01'))
        ...
        <div class="col-xl-12">
            <div class="alert alert-info d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    <h4 class="mb-1">@ {{ __('messages.sms_devices.alert.01') }}</h4>
                    <span>- {{ __('messages.sms_devices.alert.02') }}</span>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-warning fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.sms_devices.edit.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('SMSDevices.Update', $SMSDevice->id) }}" id="editForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-device_name" class="required form-label">{{ __('messages.sms_devices.form.01') }}</label>
                                <input type="text" name="input-device_name" id="input-device_name" class="form-control @error('input-device_name') is-invalid error-input @enderror" placeholder="{{ __('messages.sms_devices.form.01') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-device_name', @$SMSDevice->device_name) }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-phone_no" id="input-phone_no" class="form-control @error('input-phone_no') is-invalid error-input @enderror" placeholder="{{ __('messages.sms_devices.form.02') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-phone_no', @$SMSDevice->phone_no) }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <input type="text" name="input-gsm_api_token" id="input-gsm_api_token" class="form-control @error('input-gsm_api_token') is-invalid error-input @enderror" placeholder="{{ __('messages.sms_devices.form.03') }} {{ __('messages.forms.01') }}" maxlength="500" value="{{ old('input-gsm_api_token', @$SMSDevice->gsm_api_token) }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-credit_count" id="input-credit_count" class="form-control @error('input-credit_count') is-invalid error-input @enderror" placeholder="{{ __('messages.sms_devices.form.05') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-credit_count', @$SMSDevice->credit_count) }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active', $SMSDevice->is_active) == '1' ? 'selected' : '' }}>{{ __('messages.sms_devices.form.06.01') }}</option>
                                    <option value="0" {{ old('input-is_active', $SMSDevice->is_active) == '0' ? 'selected' : '' }}>{{ __('messages.sms_devices.form.06.02') }}</option>
                                </select>
