...
@section('PageTitle', __('messages.announcements.index.01'))
            ...
            <div class="card">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('Announcements.Create') }}" class="btn btn-light-success btn-icon btn-sm">
                    ...
                    <div class="row p-0">
                        ...
                        <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                            ...
                            <tr class="fw-bolder fs-7 text-uppercase gy-5">
                                ...
                                <th>{{ __('messages.announcements.index.datatables.01') }}</th>
                                <th>{{ __('messages.announcements.index.datatables.04') }}</th>
...
@section('PageCustomJS')
    <script>
        var table, dt;
        var editUrl = '{{ route("Announcements.Edit", ":id") }}';
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "announcements/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
