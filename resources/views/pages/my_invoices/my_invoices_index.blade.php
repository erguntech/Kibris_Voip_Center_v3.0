...
@section('PageTitle', __('messages.my_invoices.index.01'))
        ...
        <div class="col-12">
            <div class="alert alert-info d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    <h4 class="mb-1">@ {{ __('messages.my_invoices.alert.01') }}</h4>
                    <span>- {{ __('messages.my_invoices.alert.02') }}</span>
                    <span>- {{ __('messages.my_invoices.alert.03') }}</span>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            ...
                            <th>{{ __('messages.my_invoices.index.datatables.01') }}</th>
                            <th>{{ __('messages.my_invoices.index.datatables.02') }}</th>
                            <th>{{ __('messages.my_invoices.index.datatables.03') }}</th>
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "myinvoices/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
